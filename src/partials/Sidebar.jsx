                    ...
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          ...
                          {/* <li className="mb-1 last:mb-0">
                            <div onClick={() => setAllCoursesOpen(!allCoursesOpen)} className="cursor-pointer block transition duration-150 truncate text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                All Course
                              </span>
                            </div>
                              ...
                              <ul className="pl-4 mt-1">
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                    ...
                                    to="/ecommerce/course1"
                                    className={({ isActive }) =>
                                      'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                                    }
                                  >
                                    <span className="text-sm font-medium duration-200">MERN Stack Developer</span>
                                  </NavLink>
                                </li>
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                    end
                                    to="/ecommerce/course2"
                                    className={({ isActive }) =>
                                      'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                                    }
                                  >
                                    <span className="text-sm font-medium duration-200">Python Full Stack Developer</span>
                                  </NavLink>
                                </li>
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                    end
                                    to="/ecommerce/course3"
                                    className={({ isActive }) =>
                                      'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                                    }
                                  >
                                    <span className="text-sm font-medium duration-200">Java Full Stack Developer</span>
                                  </NavLink>
                                </li>
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                ...
                                <li className="mb-1 last:mb-0">
                                  ...
                                  >
                                    <span className="text-sm font-medium duration-200">Cyber Security</span>
                                  </NavLink>
                                </li>
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                  ...
                                  >
                                    <span className="text-sm font-medium duration-200">Data Analytics</span>
                                  </NavLink>
                                </li>
                                <li className="mb-1 last:mb-0">
                                  <NavLink
                                  ...
                                  >
                                    <span className="text-sm font-medium duration-200">Digital Marketing</span>
                                  </NavLink>
                                </li>
                              </ul>
                            )} */}
